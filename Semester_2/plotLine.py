...
plotLine(line1, x_time, yf_wait, 'time', 'avg Waiting time', 'FixedTime', 'navajowhite', [0,250])
plotLine(line1, xp_time, yp_wait, 'time', 'avg Waiting time', 'TSCRL', 'lightpink', [0,250])
plotLine(line1, xs_time, ys_wait, 'time', 'avg Waiting time', 'Proposed', 'cornflowerblue', [0,250])

plotLine(line2, x_time, yf_qLength, 'time', 'avg Queue length', 'FixedTime', 'navajowhite', [0,250])
plotLine(line2, xp_time, yp_qLength, 'time', 'avg Queue length', 'TSCRL', 'lightpink', [0,250])
plotLine(line2, xs_time, ys_qLength, 'time', 'avg Queue length', 'Proposed', 'cornflowerblue', [0,250])

plotLine(line3, x_epoch, yf_green, 'time', 'avg Green time', 'FixedTime', 'navajowhite', [58,68])
plotLine(line3, xp_epoch, yp_green, 'time', 'avg Green time', 'TSCRL', 'lightpink', [58,68])
plotLine(line3, xs_epoch, ys_green, 'time', 'avg Green time', 'Proposed', 'cornflowerblue', [58,68])

plotLine(line4, xp_epoch, yp_rew, 'time', 'Reward', 'TSCRL', 'lightpink', [-5, 10])
plotLine(line4, xs_epoch, ys_rew, 'time', 'Reward', 'Proposed', 'cornflowerblue', [-5,10])
